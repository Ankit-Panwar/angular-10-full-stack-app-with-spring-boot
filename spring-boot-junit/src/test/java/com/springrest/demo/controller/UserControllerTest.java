...
public class UserControllerTest {
	...
	public void deleteUserTest() throws Exception {
		Map<String, Boolean> mockUser = new HashMap<String, Boolean>();
		mockUser.put("message", Boolean.FALSE);
		Mockito.when(userService.deleteUserByIdSoftDelete(Mockito.anyInt())).thenReturn(mockUser);
